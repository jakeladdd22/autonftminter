...
const authorInfo = {
    address: "0x4DE23f3f0Fb3318287378AdbdE030cf61714b2f3", // your address 
    infuraId: 01a8be2073cf4c4c86d335dcf0d29d3b"", // your infura project id
}
...
const collectionInfo = {
    name: "Free NFTs",
    title: "Get Your NFT From Me!", // Title prefix (ex "Buy your {name}") - You can use {name} to insert the collection name
    date: "14.08.2022",
    socialMedia: {
        discord: "",
        twitter: "",
...
const mintInfo = {
    price: 0.005, // Price per NFT.
    totalSupply: 6666, // Total supply of NFTs.
